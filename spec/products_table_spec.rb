...
describe PrimeNumbers::ProductsTable do
  describe 'initializer' do
    it 'constructs a table that is n+1 by n+1 when given an array of length n' do
      products = PrimeNumbers::ProductsTable.new([1, 2, 3])
    ...
    it 'populates the first row with the supplied values' do
      products = PrimeNumbers::ProductsTable.new([10, 20, 30])
  ...
  it 'can flatten the contents of the table into a single array' do
    table = PrimeNumbers::ProductsTable.new([1, 2])
